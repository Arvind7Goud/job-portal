    ...
    e.preventDefault()
        try{
          if(!name || !lastName || !email || !password){
            return toast.error("please provide details")
          }
  ...
  return (
    <>
     {loading ? (<Spinner />) : (
       ...
       <InputFrom htmlfor="name" labelText={'Name'} type={'text'} value={name}
       handleChange={(e) => setName(e.target.value) }
       name="name" />
       <InputFrom htmlfor="lastName" labelText={'Last Name'} type={'text'} value={lastName}
